        ...
        <div>
            ...
            <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
                <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                    ...
                    <img src="https://tailus.io/sources/blocks/left-image/preview/images/startup.png" alt="about-img" loading="lazy" width="" height=""/>
                    </div>
                    <div className="md:7/12 lg:w-6/12">
                    <h2 className="text-2xl text-gray-900 font-bold md:text-4xl">GHB Knowledge Institute is carried out by passionate developers</h2>
            ...
            <div className="container p-4 mx-auto space-y-16 sm:p-10">
                <div className="space-y-4">
                    ...
                    <p className="max-w-2xl m-auto text-gray-400 text-center">At a assumenda quas cum earum ut itaque commodi saepe rem aspernatur quam natus quis nihil quod, hic explicabo doloribus magnam neque, exercitationem eius sunt!</p>
                </div>
