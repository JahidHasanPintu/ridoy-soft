             ...
             <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    ...
                    <div className='flex fetsec'>
                            <img src={atom} alt="" />
                            <div>
                            <h3 class="mb-2 text-xl font-bold dark:text-white">Innovative solutions</h3>
                        ...
                        <div className='flex fetsec'>
                            ...
                            <div>
                            <h3 class="mb-2 text-xl font-bold dark:text-white">Experienced Team</h3>
                            <p class="text-gray-500 dark:text-gray-400">Auto-assign tasks, send Slack messages, and much more. Now power up with hundreds of new templates to help you get started.</p>
                            </div>
                        </div>
                        <div className='flex fetsec'>
                            <img src={coin} alt="" />
                            <div>
                            <h3 class="mb-2 text-xl font-bold dark:text-white">Flexible Pricing</h3>
                            <p class="text-gray-500 dark:text-gray-400">Auto-assign tasks, send Slack messages, and much more. Now power up with hundreds of new templates to help you get started.</p>
                            </div>
                        </div>
                    </div>
